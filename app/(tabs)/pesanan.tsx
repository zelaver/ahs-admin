      ...
      <ScrollView>
        <View className="main py-8">
          ...
          <View className="section-3 px-5 py-3 ">
            <View className="pesanan-1 border rounded-lg p-2.5 flex-row justify-between items-center mb-4">
            ...
            <View className="pesanan-1 border rounded-lg p-2.5 flex-row justify-between items-center mb-4">
              ...
              <View className="flex-row items-center">
                <Text className="bg-yellow-500 text-gray-50 text-xs font-semibold px-3 py-1 rounded-md mr-2">Pinjam</Text>
                <Icon name="pencil-line" size={16}></Icon>
              </View>
            </View>
          </View>
